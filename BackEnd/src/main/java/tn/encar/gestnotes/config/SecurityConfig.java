	...
	@Bean
	  public SecurityFilterChain configure(HttpSecurity http) throws Exception {
       http
       	...
       	.requestMatchers(HttpMethod.POST,"api/admins/**").hasRole(Role.ADMIN.name())
       	.requestMatchers(HttpMethod.GET,"api/admins/**").hasRole(Role.ADMIN.name())
       	.requestMatchers(HttpMethod.POST,"api/enseignant/**").hasRole(Role.ADMIN.name())
       	.requestMatchers(HttpMethod.GET,"api/enseignant/**").hasAnyAuthority(Role.ADMIN.name(),Role.ENSEIGNANT.name())
       	.requestMatchers(HttpMethod.POST,"api/etudiant/**").hasRole(Role.ADMIN.name())
       	.requestMatchers(HttpMethod.GET,"api/etudiant/**").hasAnyAuthority(Role.ADMIN.name(),Role.ENSEIGNANT.name())
